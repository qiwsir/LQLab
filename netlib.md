...
- [为什么这么设计](https://draven.co/whys-the-design/?continueFlag=74946a772690244968fc029fa794e484)
- [The Linux Kernel Module Programming Guide](https://sysprog21.github.io/lkmpg/)

## 编程语言

- [源码管理开源框架：Gerrit](https://www.gerritcodereview.com/)

### Python

- [Python 源码剖析](https://fasionchan.com/python-source/?continueFlag=cbdb991f7d4a126c90f864609f7d46c4)
- [Python 进阶](https://tairraos.github.io/IntermediatePython/)

### Rust

- [Rust 实战](https://github.com/sunface/rust-by-practice)
- [绅士地介绍 Rust](https://llever.com/gentle-intro/readme.zh.html?continueFlag=6321bdb57e14c7f2321bc6dbd9197a65)
- [Rust 程序设计语言](https://kaisery.github.io/trpl-zh-cn/)
- [Rust by Example](https://doc.rust-lang.org/stable/rust-by-example/)

## WEB 开发

- [NGINX 的 Web 管理工具](https://github.com/digitalocean/nginxconfig.io)
- [用 CSS 制作的各种按钮](https://github.com/eludadev/css-buttons)
- [现代 JavaScript 教程](https://zh.javascript.info/)

## GUI 开发

- [Python GUI](https://www.pythonguis.com/)

## 数据科学和机器学习

- [基于 Python 的数据科学库](https://github.com/krzjoa/awesome-python-data-science)
...
- [机器学习和深度学习讲义、课件](https://github.com/WeiSong-bio/roboticcam-machine-learning-notes)
- [ML Recipe](https://bipinkrishnan.github.io/ml-recipe-book/about.html)
- [机器学习的学习笔记](http://www.huaxiaozhuan.com/)
- [PyTorch中文手册](https://github.com/zergtant/pytorch-handbook)
- [Pandas使用教程](http://joyfulpandas.datawhale.club/Content/index.html?continueFlag=277fd650c2d9083d56058b661f4ece85)
...
- [ApacheCN计算机视觉译文集](https://cv.apachecn.org/#/)
...
- [Python 并行编程](https://python-parallel-programmning-cookbook.readthedocs.io/zh_CN/latest/index.html)
...
- [给研究生的学术建议](https://psychelzh.github.io/phdrule/)
